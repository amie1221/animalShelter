...
@section('content')
    <div class="container text-center">
        ...
        <h2 class="py-1 bg-Light text-dark rounded"><i class="fas fa-people-carry"></i> PERSONNEL EDIT </h2>    
    </div>
    <br>
    <div class="container text-center">
    ...
    <br><br><br>
    <div class="container text-center">
	    {{	 Form::model($personnel, ['method' => 'PUT', 'route' => ['personnel.update', $personnel]])	}}
	    <div class="form-group form-horizontal">
	    	...
	    	<div class="form-group form-group-sm" >
		    	...
		    	<div class="col-sm-3">
			    	{!!	Form::date('hiredate', old('hiredate'), ['class' => 'form-control'])
			    		!!}
