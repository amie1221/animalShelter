...
<div class="navbar">
 <a href="{{route('login')}}" class="center" class="py-1 bg-Light text-light rounded" class="fas fa-dogs"><h5></i>Log in </a></h5>
  <a href="{{route('register')}}" class="center" class="py-1 bg-Light text-light rounded" class="fas fa-dogs"><h5></i>Create New Account </a></h5>
  </div>
        ...
        <?php
          foreach ($animals as $animal) {
            echo '<div class="col-md-3">
                    <div class="thumbnail">
                        <img src="'.$animal['aniImage'].'" alt="'.$animal['aniName'].'" style="height:200px;max-width:200px;width: expression(this.width > 200 ? 200: true);">
                        <div class="caption">
                          <p><h5>Pet Name: <b>'.$animal['aniName'].'</b></h5></p>
                          <p>
                              Breed: <b>'.$animal['aniBreed'].'</b><br>
                              Size: <b>'.$animal['aniSize'].'</b><br>
                              Color: <b>'.$animal['aniColor'].'</b><br>
                              Date Rescued: <b>'.$animal['date_added'].'</b><br>
                              Availability: <b>'.$animal['aniStatus'].'</b>
                          </p>
                        </div>
                    </div>
                  </div>';
...
<div class="container text-center">
       <h4><a href="{{route('welcome')}}" class="py-1 bg-Light text-dark rounded"><i class="far fa-comment-dots"></i>     Questions? <u> Email Us here</u> </h4>  
</div>
  </body>
</html>