...
@section('content')
    ...
    <br><br><br>
    <div class="container text-center">
	    {{	 Form::model($animal, ['method' => 'PUT', 'route' => ['animal.healthupdate', $animal]])	}}
	    <div class="form-group form-horizontal">
	    	...
	    	<div class="form-group form-group-sm" >
                ...
                <div class="col-sm-3 col-sm-offset-3">
                	...
                	{{ Form::select('disease_id[]',$disease,null, ['id' => 'multiple-select', 'class' => 'form-control multiple-select', 'multiple' => 'multiple'])}}
       			</div>
                  <div class="col-sm-offset-5 col-sm-2">
                	{!!	Form::submit('Update Health', ['class' => 'btn btn-primary'])	!!}
                	</div>
                </div>
            </div>
        </div>
