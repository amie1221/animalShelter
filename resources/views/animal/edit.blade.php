...
@section('content')
    <div class="container text-center">
        ...
        <h2 class="py-1 bg-Light text-dark rounded"><i class="fas fa-people-carry"></i> ANIMAL EDIT </h2>    
    </div>
    <br>
    <div class="container text-center">
    ...
    <br><br><br>
    <div class="container text-center">
	    {{	 Form::model($animal, ['method' => 'PUT', 'route' => ['animal.update', $animal]])	}}
	    <div class="form-group form-horizontal">
	    	...
	    	<div class="form-group form-group-sm" >
	    		<div class="col-sm-offset-5 col-sm-2">
			    	{{ Form::label('aniImage', null, ['class' => 'control-label']) }}
